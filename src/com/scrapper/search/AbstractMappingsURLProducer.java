...
public abstract class AbstractMappingsURLProducer
  ...
  implements HasUrlSubs
{
  ...
  protected List getSubs(String tableName, Map parameters, JsonConfig config)
  {
    ...
    if (oval != null)
    {
      ...
      List typeSubs = getSubs(Config.Extractor.type.name(), oval, config);
  ...
  protected List getSubs(String name, Object value, JsonConfig config)
  {
    ...
    XLogger.getInstance().log(Level.FINER, "url.mappings.{0}={1}", getClass(), name, tableMappings);
