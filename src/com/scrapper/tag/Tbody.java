...
/**
 * @(#)Tbody.java   28-Mar-2013 00:05:23
 *
 ...
 * @since    0.0
 */
public class Tbody extends CompositeTag {
     ...
     */
    private static final String[] mEnders = new String[] {"TBODY", "TFOOT", "THEAD", "BODY", "HTML"};

    /**
     * The set of end tag names that indicate the end of this tag.
     */
    private static final String[] mEndTagEnders = new String[] {"TFOOT", "THEAD", "TABLE", "BODY", "HTML"};
